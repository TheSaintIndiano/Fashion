...
from config import autotpot_config
...
class AutoTpot:
    ...
    def sample(self):
        ...
        # Loading the best model discovered through AutoTpot pipeline
        automl = list(autotpot_config.best_model.values())[0]
